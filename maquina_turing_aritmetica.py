...
class InterfazMaquinaTuring:
    ...
    def crear_interfaz(self):
        ...
        # Título
        titulo = ttk.Label(main_frame, text="🔧 Máquina de Turing - Operaciones Aritméticas",
        ...
        # Frame de operación
        op_frame = ttk.LabelFrame(main_frame, text="Operación", padding="10")
        op_frame.grid(row=2, column=0, columnspan=3, sticky=(tk.W, tk.E), pady=(0, 10))
        
        # Tipo de operación
        ttk.Label(op_frame, text="Tipo:").grid(row=0, column=0, sticky=tk.W, padx=(0, 10))
        self.tipo_operacion = ttk.Combobox(op_frame, values=["Suma", "Multiplicación"], 
                                           state="readonly", width=15)
        self.tipo_operacion.set("Suma")
        self.tipo_operacion.grid(row=0, column=1, sticky=tk.W, padx=(0, 20))
        
        # Primer número
        ttk.Label(op_frame, text="Número a:").grid(row=0, column=2, sticky=tk.W, padx=(0, 10))
        self.num_a = ttk.Entry(op_frame, width=10)
        self.num_a.insert(0, "3")
        self.num_a.grid(row=0, column=3, sticky=tk.W, padx=(0, 20))
        
        # Segundo número
        ttk.Label(op_frame, text="Número b:").grid(row=0, column=4, sticky=tk.W, padx=(0, 10))
        self.num_b = ttk.Entry(op_frame, width=10)
        self.num_b.insert(0, "2")
        self.num_b.grid(row=0, column=5, sticky=tk.W)
        ...
        ttk.Button(botones_frame, text="▶️ Ejecutar", 
                  command=self.ejecutar_operacion, width=15).grid(row=0, column=0, padx=5)
        ...
        self.resultado_texto = scrolledtext.ScrolledText(resultado_frame, width=90, height=15,
        ...
        self.traza_texto = scrolledtext.ScrolledText(traza_frame, width=90, height=15,
        ...
        self.notebook.add(cinta_frame, text="📼 Visualización de Cinta")
